...
//check if a user is logged in, if so chnage the get started button to dashboard
//if not, keep it as get started
...
const HeroSection = () => {
  ...
  <section className="relative py-12 bg-gradient-to-b from-[#F8F9FF] to-white overflow-hidden">
    <div 
    ...
    <div className="absolute top-10 left-10 w-24 h-24 bg-blue-100 rounded-full blur-2xl opacity-40" />
    <div className="absolute bottom-10 right-10 w-28 h-28 bg-purple-100 rounded-full blur-2xl opacity-40" />
    ...
    <div className="relative max-w-5xl mx-auto px-4">
      ...
      <Link
        ...
        className="bg-primary rounded-lg px-6 py-4 text-white font-bold flex items-center"
      >
